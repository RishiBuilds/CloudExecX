...
export default function SignInPage() {
  return (
    <div className="relative min-h-screen bg-[#080c10] flex items-center justify-center p-8 overflow-hidden font-sans">
      ...
      {/* Accent orbs */}
      <div className="absolute -top-24 -left-24 w-[400px] h-[400px] rounded-full bg-[#00ff88]/[0.06] blur-[80px] pointer-events-none" />
      <div className="absolute -bottom-20 -right-20 w-[400px] h-[400px] rounded-full bg-indigo-500/[0.07] blur-[80px] pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-[420px]">
        ...
        <div className="text-center mb-8">
          ...
          <p className="font-mono text-[12px] text-[#4a6177] tracking-[0.5px]">
            $ ssh user@<span className="text-[#00ff88]">cloudexecx.dev</span>
          </p>
        </div>
        ...
        <div className="flex items-center justify-center gap-1.5 mt-6">
          ...
          <span className="font-mono text-[10px] text-[#2a3f52] tracking-[0.5px]">
            Execution environment online · 3 regions active
          </span>
        </div>
      </div>
    </div>
